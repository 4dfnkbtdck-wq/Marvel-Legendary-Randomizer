...
const KEYWORDS = [
  ...
  { term: "Artifact", definition: "A card that stays in front of you turn after turn once played, instead of going to your discard pile at the end of the turn — usable again on later turns without being played again." },
  ...
  { term: "Burrow", definition: "A keyword letting a Villain retreat to the Streets when fought there, instead of being defeated — fight it there again, or while another Villain occupies the Streets, to actually finish it off." },
  ...
  { term: "Celestial Boon", definition: "A permanent bonus effect granted by defeating a Celestial — active for the rest of the game as long as that Celestial stays in your Victory Pile, and stacking with each copy you've defeated." },
  { term: "Charge", definition: "A keyword letting a Villain push forward an extra city space right after entering, potentially causing more Villains to escape." },
  { term: "Cheering Crowds", definition: "A keyword letting you play this card twice in a row by returning a Bystander from your Victory Pile to the Bystander stack." },
  ...
  { term: "Circle of Kung-Fu", definition: "A keyword giving a Villain or Mastermind a large Fight Point bonus unless you reveal a Hero costing at least a specific amount — if it already has one Circle and a Scheme gives it another, only the higher one counts." },
  { term: "Clone", definition: "A keyword letting you gain another copy of this card from the HQ (or the Hero Deck if none are available in the HQ) the moment you recruit or Ambush it." },
  { term: "Command", definition: "A keyword giving a Villain a Fight Point bonus and/or extra abilities as long as it's the leftmost Villain of its Villain Group in the city." },
  ...
  { term: "Contest of Champions", definition: "A keyword where every player reveals a card to compare printed costs — the highest score (ties included) wins, while Evil competes using the best of two cards revealed from the Hero Deck." },
  { term: "Coordinate", definition: "A keyword letting you discard the card from your hand (drawing a replacement) so another player can play a free copy of it on their own turn, if they choose to accept it." },
  { term: "Copy a Hero", definition: "An ability that turns this card into an exact duplicate of a Hero you've already played this turn, gaining all of that Hero's stats and text for as long as it stays in play." },
  { term: "Cosmic Threat", definition: "A keyword giving a Villain or Mastermind a huge Fight Point penalty for revealing cards of a specific color, usable once per turn during a single fight." },
  { term: "Critical Hit", definition: "A Superpower Ability requiring two different Hero Class icons instead of one — usable only if you've already played a card of each class earlier in your turn." },
  { term: "Cross-Dimensional Rampage", definition: "A keyword forcing each player to reveal a Hero or Victory Pile card matching a specific theme (like 'Party' or 'Demon') from their own cards, or else gain a Wound." },
  { term: "Cyber-Mod", definition: "A keyword usable only if you have a card of the listed Hero Class in your Victory Pile — Villains and Masterminds have their own version, usable only while a card of the listed class sits in the Escape Pile instead." },
  { term: "Danger Sense", definition: "A keyword that reveals cards from the top of the Villain Deck, gives you a Fight Point bonus for each Villain revealed, then returns all the cards to the top in any order you choose." },
  { term: "Dark Memories", definition: "A keyword giving a Fight Point bonus based on how many distinct Hero Classes appear among the cards in your discard pile." },
  { term: "Defeat", definition: "An instruction to treat an enemy as defeated without paying its Fight cost or meeting any special fighting requirements — you still get its Fight effect and Victory Points as normal." },
  { term: "Demolish", definition: "A keyword that reveals the top card of the Hero Deck, then forces each player to discard a card from their hand matching its cost." },
  { term: "Demonic Bargain", definition: "A keyword letting a chosen player discard the top card of their deck — if it costs 1 or more, they gain a Wound, but either way they get the listed bonus effect." },
  { term: "Digest", definition: "A keyword usable only if you have at least a specific number of cards in your Victory Pile — any kind of card there counts, and using it doesn't remove any." },
  ...
  { term: "Escape", definition: "An effect that triggers when a Villain is pushed off the final city space without being defeated, instead of being fought." },
  { term: "Evil Wins", definition: "The part of every Scheme card explaining exactly how the Mastermind completes their plan and wins the game for evil, if the players don't stop it in time." },
  { term: "Excessive Kindness", definition: "A keyword usable once per turn — spend 1 more Recruit Point than needed to recruit a Hero, and you get to use every Excessive Kindness ability on the Heroes you've played this turn." },
  { term: "Excessive Violence", definition: "A keyword usable once per turn — spend one more Attack than needed to defeat a Villain or Mastermind, and you get to use every Excessive Violence ability on the Heroes you've played this turn." },
  { term: "Explore", definition: "A keyword that swaps a Hero out of the HQ for a fresh one from the top of the Hero Deck, sometimes granting a bonus based on the Hero it finds." },
  { term: "Fail", definition: "What happens when you try to fight a Berserk enemy but don't have enough Fight Points after its bonus applies — you gain a Wound, lose all your Fight Points, and can't fight again this turn, though you can still play cards and recruit." },
  { term: "Fated Future", definition: "A keyword letting you put this card on the bottom of your deck instead of your discard pile when you play it, so you draw it again once your deck cycles instead of waiting for a reshuffle." },
  { term: "Fateful Resurrection", definition: "A keyword that reveals the top card of the Villain Deck when this Villain is fought — if it's a Scheme Twist or Master Strike, this Villain reenters the city instead of going to your Victory Pile." },
  { term: "Feast", definition: "A keyword that treats fighting this Villain or Mastermind as also triggering its listed Fight effect — most commonly used to KO the top card of a player's deck." },
  { term: "Fight", definition: "Spending Attack Points to defeat a Villain in the city, a Bystander, or a Master Strike." },
  { term: "Fight or Fail", definition: "A secondary effect on enemies with Uru-Enchanted Weapons — it triggers whenever you fight that enemy, whether or not you actually had enough Fight Points to defeat it." },
  ...
  { term: "Fortify", definition: "A keyword that makes a Villain immune to being fought while it sits at a specified location — fighting that Villain there ends the effect and puts it in your Victory Pile as normal." },
  ...
  { term: "Haunt", definition: "A keyword that tucks this Villain beneath an unhaunted Hero in the HQ instead of entering the city, blocking that Hero from being recruited until a player pays Fight Points equal to its cost to exorcise it and send the Villain into the city." },
  ...
  { term: "Heroic Bystanders", definition: "A Special Bystander that becomes a Hero card and joins your discard pile when you rescue it, instead of just adding Victory Points." },
  ...
  { term: "Horrors", definition: "An optional, extra-tough card type that some Epic Masterminds add to the game for a harder challenge — players can also choose to add any number of Horrors at the start of a game against any Mastermind, just to raise the difficulty." },
  { term: "HQ", definition: "The row of face-up Hero cards available to Recruit from." },
  { term: "Human Shields", definition: "A keyword that captures Bystanders face-down instead of face-up — you can't fight that Villain at all until you've individually paid to rescue each Human Shield, at a cost equal to the Villain's current Fight value." },
  ...
  { term: "Indigestion", definition: "A fallback ability on cards that also have Digest — use this weaker effect instead if you don't have enough cards in your Victory Pile to meet the Digest requirement." },
  ...
  { term: "Last Stand", definition: "A keyword giving a Fight Point bonus for each empty city space — a space still counts as empty even if it has a Location above it, as long as no Villain is there." },
  { term: "Liberate", definition: "A keyword giving a Fight Point bonus usable only against a Villain holding Bystanders, or against the Mastermind (whether or not it's holding Bystanders)." },
  { term: "Lightshow", definition: "A keyword usable once per turn if you've played at least two cards with it — pick a single Lightshow ability from any of those cards to use, no matter how many more you've played." },
  ...
  { term: "Mastermind Tactic", definition: "One of four face-down cards under a Mastermind — drawn at random and revealed each time you fight it, its Fight effect applies before it goes to the KO pile." },
  ...
  { term: "Outwit", definition: "A keyword usable only if you reveal Heroes with a specific number of different printed costs among your hand and the cards you've already played this turn — the card itself counts toward that total." },
  ...
  { term: "Piercing Energy", definition: "A special resource some Heroes generate, letting you fight a Villain or Mastermind by spending Piercing Energy equal to its printed Victory Points instead of its Fight value — ignoring its Fight value, any Fight modifiers, and most special fighting requirements." },
  { term: "Prey", definition: "A keyword that has this Villain single out whichever player has the fewest cards of a specific type in hand when it enters the city — if nobody defeats it by the end of that player's turn, its 'Finish the Prey' effect triggers against them." },
  { term: "Printed Value", definition: "The number literally shown inside a card's Attack, Recruit, or Cost icon, ignoring any current bonuses, penalties, or modifiers — some abilities specifically check this raw value instead of a card's current one." },
  ...
  { term: "Reveal", definition: "Show the other players a card from your hand or one you've already played this turn — revealing a card doesn't play, discard, or otherwise move it." },
  { term: "Revenge", definition: "A keyword giving a Villain a Fight Point bonus for each Villain from a specific group already in your Victory Pile." },
  ...
  { term: "Shatter", definition: "A keyword that halves an enemy's — or a Hero's in the HQ — current Fight value or cost, rounded up, for the rest of the turn. It can stack if used multiple times." },
  ...
  { term: "Smash", definition: "A keyword letting you discard another card from your hand for a Fight Point bonus." },
  { term: "Soaring Flight", definition: "A keyword that sets a Hero aside the moment you recruit it, adding it to your hand as a bonus extra card at the end of that turn." },
  { term: "Soulbind", definition: "A keyword letting you take a Villain card from your Victory Pile and turn it face down at the bottom of the pile for a bonus effect — it stops counting as being in your Victory Pile until you tally Victory Points at the end of the game." },
  ...
  { term: "Spectrum", definition: "A keyword usable only if you have at least 3 different Hero Classes among your hand and the cards you've played this turn." },
  { term: "Striker", definition: "A keyword giving a Fight Point bonus for each Master Strike currently in the KO pile and/or stacked next to the Mastermind — some Masterminds count Master Strikes in other unusual places instead, like the city or players' Victory Piles." },
  { term: "Sunlight", definition: "A keyword active only when most Heroes in the HQ have even-numbered printed costs — the counterpart to Moonlight." },
  { term: "Superpower Ability", definition: "A bonus effect on a Hero card, marked with a Hero Class icon and a colon, usable only if you've already played another card of that same class earlier in the turn." },
  { term: "Switcheroo", definition: "A keyword used instead of playing a card — reveal it from your hand and put it on the bottom of the Hero Deck, then take a Hero of the matching printed cost from the HQ into your hand." },
  { term: "Symbiote Bonds", definition: "A keyword letting you stack a Villain onto another Villain in the same city space, combining them into a single Combined Villain with both cards' Fight values and abilities added together — fight it by paying the total, then choose one of the two cards for your Victory Pile and its Fight effect." },
  { term: "Tactical Formation", definition: "A Superpower-like ability usable only if you have a specific combination of Hero costs among 'Heroes you have,' counting the card itself." },
  { term: "Teleport", definition: "A keyword letting you set this card aside instead of playing it — it joins your hand as a bonus extra card at the end of your turn." },
  ...
  { term: "Thrown Artifact", definition: "An Artifact that can be 'thrown' — put it on the bottom of your deck to use its ability immediately, instead of keeping it in play, so it can shuffle back into your hand again quickly." },
  { term: "Token Cards", definition: "A card representing a special character that enters the game some other way (like a Master Strike ability) instead of being recruited or drawn normally — purely optional to include." },
  { term: "Transform", definition: "An instruction to swap a card for a different one — on a Mastermind, flip the double-sided card over to its other side; on a Hero, permanently replace it with a new card, removing the original from the game." },
  { term: "Transforming Scheme", definition: "A double-sided Scheme that starts on its 'Setup' side and flips to its other side the moment a Twist tells it to — only the rules on the currently face-up side apply from that point on." },
  { term: "Traps", definition: "A card type in the Villain Deck that gives you a challenge to complete that turn — succeed and it goes to your Victory Pile for its Victory Points, fail and you suffer its listed consequence at the end of the turn. Traps don't push Villains forward when played." },
  { term: "Triggered Artifact", definition: "An Artifact with a repeatable ability that fires every time a specific trigger happens during your turn, for as long as you control it." },
  ...
  { term: "Unveiled Scheme", definition: "The transformed side of a Veiled Scheme — once triggered, the original Scheme is removed from the game and replaced with a randomly selected Unveiled Scheme from among the ones in play, continuing the game with new rules." },
  ...
  { term: "Villains You Gain as Heroes", definition: "A rare card type that starts in the Villain Deck as a Villain, but the moment you defeat it in a fight, it becomes a Hero and joins your discard pile instead of your Victory Pile — its old Villain Attack value doubles as its Hero cost if anything needs to know it." },
  { term: "Waking Nightmare", definition: "A keyword that discards a non-grey Hero from your hand — if you discard a Hero this way, draw a card." },
  { term: "Wall-Crawl", definition: "A keyword letting you put this Hero on top of your deck instead of your discard pile when you recruit it — you'll draw it again almost immediately instead of waiting for your deck to reshuffle." },
  { term: "Weapon X Sequence", definition: "A keyword giving a bonus equal to the longest unbroken run of different consecutive printed costs among your cards — on a Hero it's your own hand and cards played this turn, on an enemy it's the Heroes currently in the HQ." },
  { term: "What If...?", definition: "A keyword letting you choose a Hero Class or Hero Name, then reveal the top card of your deck and choose to keep it on top or discard it — if the revealed card matches what you chose, you get the listed bonus effect." },
  ...
  { term: "Wounded Fury", definition: "A keyword giving a Fight Point bonus for each Wound in your discard pile — appears on both Heroes (boosting themselves) and Villains/Masterminds (making them tougher)." },
  { term: "X-Gene", definition: "A keyword giving a bonus if you have at least one card of a specific Hero Class in your discard pile — it doesn't matter how many matching cards you have, and it only triggers once per card even if you meet several different X-Gene conditions on it." },

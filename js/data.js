 ...
 * pick from just that subset) — most Heroes have none. It can also carry
...
//                  app.js), or `weddingHeroes` (a boolean — for a Scheme
//                  that sets aside two extra Heroes as a gendered pair,
//                  e.g. Realm of Kings' "Ruin the Perfect Wedding": "Set
//                  aside two extra Heroes to get married." The app picks
//                  one Hero tagged `gender: "male"` and one tagged
//                  `gender: "female"` — see the Hero doc comment above —
//                  from whichever are currently eligible (not already in
//                  the main Hero Deck), shown in their own "Wedding
//                  Heroes" section with each slot independently
//                  rerollable; see syncWeddingHeroes/rerollWeddingHero in
//                  app.js).
...
const SCHEMES = [
  ...
  // The four New Mutants Schemes below are transcribed directly from the
  // physical cards. None of their "stack a Twist/card as a named token,
  // Evil Wins at N of them" Evil Wins conditions are mechanically tracked
  // (no expansion's Schemes track accumulated tokens) — they're left as
  // reference-only `evilWins` text, same as elsewhere in this file.
  {
  ...
  },
  {
    ...
    exp: "new_mutants",
    overrides: { twists: 8, requiredVillainGroup: "Demons of Limbo" },
    setupNote:
      'Put the Demon Bear Villain from that group next to the Scheme.\nSpecial Rules: Whenever the Demon Bear escapes, stack a Twist next to the Scheme as a "Dream Horror."',
    twist:
  ...
  },
  {
    ...
    twist:
      'Play the top card of the Villain Deck. If it\'s a Bystander, rescue that "Cheering Fan." If it\'s a Master Strike, then after it resolves, any Villain on Third Base "Steals Home" and Escapes. If it\'s a Villain, it "Hits a Double," pushes to Second Base (the Rooftops) and you play the top card from the Villain Deck.',
    evilWins: 'When Evil has 4 "runs" (Villains in the Escape Pile) per player.',
  },
  {
    name: "Trapped in the Insane Asylum",
    exp: "new_mutants",
    overrides: { twistsByPlayers: { 1: 3, 2: 5, 3: 7, 4: 9, 5: 11 } },
    setupNote:
  ...
  // stub data. "Ruin the Perfect Wedding"'s "set aside two extra Heroes
  // to get married" is modeled by `weddingHeroes` (one male-tagged Hero,
  // one female-tagged Hero); preparing each into its own ordered
  // 14-card stack and manipulating those stacks by Twist isn't modeled
  // and stays as reference-only text. "Tornado of Terrigen Mists"'s
  // city-space movement tracking and "War of Kings"'s stacked
  // "Battlefront"/"Victorious General" escalation are likewise left as
  // reference-only setup/twist text — neither fits any existing
  // `overrides` mechanic, same as other one-off Scheme mechanics
  // elsewhere in this file.
  {
    name: "Ruin the Perfect Wedding",
    exp: "realm_of_kings",
    overrides: { twists: 11, weddingHeroes: true },
    setupNote:
      'Prepare each Wedding Hero into a separate 14-card stack, ordered by cost with the lowest cost on top.',
    twist:
...
const HEROES = [
  { name: "Black Widow", exp: "core", team: "Avengers", gender: "female" },
  { name: "Captain America", exp: "core", team: "Avengers", gender: "male" },
  { name: "Cyclops", exp: "core", team: "X-Men", gender: "male" },
  { name: "Deadpool", exp: "core", gender: "male" },
  { name: "Emma Frost", exp: "core", team: "X-Men", gender: "female" },
  { name: "Gambit", exp: "core", team: "X-Men", gender: "male" },
  { name: "Hawkeye", exp: "core", team: "Avengers", gender: "male" },
  { name: "Hulk", exp: "core", team: "Avengers", gender: "male" },
  { name: "Iron Man", exp: "core", team: "Avengers", gender: "male" },
  { name: "Nick Fury", exp: "core", team: "S.H.I.E.L.D.", gender: "male" },
  { name: "Rogue", exp: "core", team: "X-Men", gender: "female" },
  { name: "Spider-Man", exp: "core", team: "Spider-Friends", gender: "male" },
  { name: "Storm", exp: "core", team: "X-Men", gender: "female" },
  { name: "Thor", exp: "core", team: "Avengers", gender: "male" },
  { name: "Wolverine", exp: "core", team: "X-Men", gender: "male" },

  { name: "Angel", exp: "dark_city", team: "X-Men", gender: "male" },
  { name: "Bishop", exp: "dark_city", team: "X-Men", gender: "male" },
  { name: "Blade", exp: "dark_city", team: "Marvel Knights", gender: "male" },
  { name: "Cable", exp: "dark_city", team: "X-Force", gender: "male" },
  { name: "Colossus", exp: "dark_city", team: "X-Force", gender: "male" },
  { name: "Daredevil", exp: "dark_city", team: "Marvel Knights", gender: "male" },
  { name: "Domino", exp: "dark_city", team: "X-Force", gender: "female" },
  { name: "Elektra", exp: "dark_city", team: "Marvel Knights", gender: "female" },
  { name: "Forge", exp: "dark_city", team: "X-Force", gender: "male" },
  { name: "Ghost Rider", exp: "dark_city", team: "Marvel Knights", gender: "male" },
  { name: "Iceman", exp: "dark_city", team: "X-Men", gender: "male" },
  { name: "Iron Fist", exp: "dark_city", team: "Marvel Knights", gender: "male" },
  { name: "Jean Grey", exp: "dark_city", team: "X-Men", gender: "female" },
  { name: "Nightcrawler", exp: "dark_city", team: "X-Men", gender: "male" },
  { name: "Professor X", exp: "dark_city", team: "X-Men", gender: "male" },
  { name: "Punisher", exp: "dark_city", team: "Marvel Knights", gender: "male" },
  { name: "Wolverine", exp: "dark_city", team: "X-Force", gender: "male" },

  { name: "Human Torch", exp: "fantastic_four", team: "Fantastic Four", gender: "male" },
  { name: "Invisible Woman", exp: "fantastic_four", team: "Fantastic Four", gender: "female" },
  { name: "Mr. Fantastic", exp: "fantastic_four", team: "Fantastic Four", gender: "male" },
  { name: "Silver Surfer", exp: "fantastic_four", gender: "male" },
  { name: "Thing", exp: "fantastic_four", team: "Fantastic Four", gender: "male" },
  ...
  { name: "Scarlet Spider", exp: "paint_town_red", team: "Spider-Friends", gender: "male" },
  { name: "Spider-Woman", exp: "paint_town_red", team: "Spider-Friends", gender: "female" },
  { name: "Symbiote Spider-Man", exp: "paint_town_red", team: "Spider-Friends", gender: "male" },

  { name: "Drax the Destroyer", exp: "guardians", team: "Guardians of the Galaxy", gender: "male" },
  { name: "Gamora", exp: "guardians", team: "Guardians of the Galaxy", gender: "female" },
  { name: "Groot", exp: "guardians", team: "Guardians of the Galaxy", gender: "male" },
  ...
  { name: "Nova", exp: "champions", team: "Champions", keywords: ["Size-Changing"], gender: "male" },
  { name: "Totally Awesome Hulk", exp: "champions", team: "Champions", keywords: ["Size-Changing"], gender: "male" },
  { name: "Viv Vision", exp: "champions", team: "Champions", keywords: ["Size-Changing"], gender: "female" },

  { name: "Captain America, Secret Avenger", exp: "civil_war", team: "Avengers", gender: "male" },
  { name: "Cloak & Dagger", exp: "civil_war", team: "Avengers" },
  { name: "Daredevil", exp: "civil_war", team: "Avengers", gender: "male" },
  { name: "Falcon", exp: "civil_war", team: "Avengers", gender: "male" },
  { name: "Goliath", exp: "civil_war", team: "Avengers", keywords: ["Size-Changing"], gender: "male" },
  { name: "Hercules", exp: "civil_war", team: "Avengers", gender: "male" },
  { name: "Hulkling", exp: "civil_war", team: "Avengers", keywords: ["Size-Changing"], gender: "male" },
  { name: "Luke Cage", exp: "civil_war", team: "Avengers", gender: "male" },
  { name: "Patriot", exp: "civil_war", team: "Avengers", gender: "male" },
  { name: "Peter Parker", exp: "civil_war", team: "Avengers", gender: "male" },
  { name: "Speedball", exp: "civil_war", team: "New Warriors", gender: "male" },
  { name: "Stature", exp: "civil_war", team: "Avengers", keywords: ["Size-Changing"], gender: "female" },
  { name: "Storm & Black Panther", exp: "civil_war", team: "Avengers" },
  { name: "Tigra", exp: "civil_war", team: "Avengers", gender: "female" },
  ...
  { name: "Super-Skrull", exp: "annihilation", gender: "male" },

  { name: "Ant-Man", exp: "ant_man", team: "Avengers", keywords: ["Size-Changing"], gender: "male" },
  { name: "Black Knight", exp: "ant_man", team: "Avengers", gender: "male" },
  { name: "Jocasta", exp: "ant_man", team: "Avengers", keywords: ["Size-Changing"], gender: "female" },
  { name: "Wasp", exp: "ant_man", team: "Avengers", keywords: ["Size-Changing"], gender: "female" },
  { name: "Wonder Man", exp: "ant_man", team: "Avengers", keywords: ["Size-Changing"], gender: "male" },

  { name: "Agent X-13", exp: "cap_75", team: "S.H.I.E.L.D.", gender: "female" },
  { name: "Captain America (Falcon)", exp: "cap_75", team: "Avengers", gender: "male" },
  { name: "Captain America 1941", exp: "cap_75", team: "Avengers", gender: "male" },
  { name: "Steve Rogers, Director of S.H.I.E.L.D.", exp: "cap_75", team: "S.H.I.E.L.D.", gender: "male" },
  { name: "Winter Soldier", exp: "cap_75", gender: "male" },

  { name: "Bob, Agent of HYDRA", exp: "deadpool", team: "HYDRA", gender: "male" },
  { name: "Deadpool", exp: "deadpool", team: "Mercs For Money", gender: "male" },
  { name: "Slapstick", exp: "deadpool", team: "Mercs For Money", gender: "male" },
  { name: "Solo", exp: "deadpool", team: "Mercs For Money", gender: "male" },
  { name: "Stingray", exp: "deadpool", team: "Mercs For Money", gender: "male" },

  { name: "Howard the Duck", exp: "dimensions", gender: "male" },
  { name: "Jessica Jones", exp: "dimensions", team: "Marvel Knights", gender: "female" },
  { name: "Man-Thing", exp: "dimensions", gender: "male" },
  ...
  { name: "Beta Ray Bill", exp: "asgard", team: "Heroes of Asgard", gender: "male" },
  { name: "Lady Sif", exp: "asgard", team: "Heroes of Asgard", gender: "female" },
  { name: "Thor", exp: "asgard", team: "Heroes of Asgard", gender: "male" },
  { name: "Valkyrie", exp: "asgard", team: "Heroes of Asgard", gender: "female" },
  { name: "The Warriors Three", exp: "asgard", team: "Heroes of Asgard" },

  { name: "Adam Warlock", exp: "into_the_cosmos", team: "Avengers", gender: "male" },
  { name: "Captain Mar-Vell", exp: "into_the_cosmos", team: "Avengers", gender: "male" },
  { name: "Moondragon", exp: "into_the_cosmos", team: "Avengers", gender: "female" },
  { name: "Nebula", exp: "into_the_cosmos", team: "Guardians of the Galaxy", gender: "female" },
  { name: "Nova", exp: "into_the_cosmos", team: "Avengers", gender: "male" },
  { name: "Phyla-Vell", exp: "into_the_cosmos", team: "Guardians of the Galaxy", gender: "female" },
  { name: "Quasar", exp: "into_the_cosmos", team: "Avengers", gender: "male" },
  { name: "Ronan the Accuser", exp: "into_the_cosmos", gender: "male" },
  { name: "Yondu", exp: "into_the_cosmos", team: "Guardians of the Galaxy", gender: "male" },

  { name: "M", exp: "messiah_complex", team: "X-Factor Investigations", gender: "female" },
  { name: "Multiple Man", exp: "messiah_complex", team: "X-Factor Investigations", gender: "male" },
  { name: "Rictor", exp: "messiah_complex", team: "X-Factor Investigations", gender: "male" },
  { name: "Shatterstar", exp: "messiah_complex", team: "X-Force", gender: "male" },
  { name: "Siryn", exp: "messiah_complex", team: "X-Factor Investigations", gender: "female" },
  { name: "Stepford Cuckoos", exp: "messiah_complex", team: "X-Men", gender: "female" },
  { name: "Strong Guy", exp: "messiah_complex", team: "X-Factor Investigations", gender: "male" },
  { name: "Warpath", exp: "messiah_complex", team: "X-Force", gender: "male" },

  { name: "Karma", exp: "new_mutants", team: "X-Men", gender: "female" },
  { name: "Mirage", exp: "new_mutants", team: "X-Men", gender: "female" },
  { name: "Sunspot", exp: "new_mutants", team: "X-Men", gender: "male" },
  { name: "Warlock", exp: "new_mutants", team: "X-Men", gender: "male" },
  { name: "Wolfsbane", exp: "new_mutants", team: "X-Men", gender: "female" },

  { name: "Angel Noir", exp: "noir", team: "X-Men", gender: "male" },
  { name: "Daredevil Noir", exp: "noir", team: "Marvel Knights", gender: "male" },
  { name: "Iron Man Noir", exp: "noir", team: "Avengers", gender: "male" },
  { name: "Luke Cage Noir", exp: "noir", team: "Marvel Knights", gender: "male" },
  { name: "Spider-Man Noir", exp: "noir", team: "Spider-Friends", gender: "male" },

  { name: "Black Bolt", exp: "realm_of_kings", team: "Inhumans", gender: "male" },
  { name: "Crystal", exp: "realm_of_kings", team: "Inhumans", gender: "female" },
  { name: "Gorgon", exp: "realm_of_kings", team: "Inhumans", gender: "male" },
  ...
  { name: "Enchantress", exp: "villains", team: "Foes of Asgard", gender: "female" },
  { name: "Green Goblin", exp: "villains", team: "Sinister Six", gender: "male" },
  { name: "Juggernaut", exp: "villains", team: "Brotherhood", gender: "male" },
  { name: "Kingpin", exp: "villains", team: "Crime Syndicate", gender: "male" },
  { name: "Kraven", exp: "villains", team: "Sinister Six", gender: "male" },
  { name: "Loki", exp: "villains", team: "Foes of Asgard", gender: "male" },
  { name: "Magneto", exp: "villains", team: "Brotherhood", gender: "male" },
  ...
  { name: "Captain America", exp: "first_ten_years", team: "Avengers", gender: "male" },
  { name: "Hawkeye", exp: "first_ten_years", team: "Avengers", gender: "male" },
  { name: "Hulk", exp: "first_ten_years", team: "Avengers", gender: "male" },
  { name: "Iron Man", exp: "first_ten_years", team: "Avengers", gender: "male" },
  { name: "Nick Fury", exp: "first_ten_years", team: "S.H.I.E.L.D.", gender: "male" },
  { name: "Thor", exp: "first_ten_years", team: "Avengers", gender: "male" },

  { name: "Apocalyptic Black Widow", exp: "what_if", team: "Guardians of the Multiverse", gender: "female" },
  { name: "Captain Carter", exp: "what_if", team: "Guardians of the Multiverse", gender: "female" },
  { name: "Doctor Strange Supreme", exp: "what_if", team: "Guardians of the Multiverse", gender: "male" },
  { name: "Gamora, Destroyer of Thanos", exp: "what_if", team: "Guardians of the Multiverse", gender: "female" },
  { name: "Killmonger, Spec Ops", exp: "what_if", team: "Guardians of the Multiverse", gender: "male" },
  { name: "Party Thor", exp: "what_if", team: "Guardians of the Multiverse", gender: "male" },
  { name: "Star-Lord T'Challa", exp: "what_if", team: "Guardians of the Multiverse", gender: "male" },
  { name: "Uatu, The Watcher", exp: "what_if", team: "Guardians of the Multiverse", gender: "male" },

  { name: "Black Widow", exp: "core_2nd", team: "Avengers", gender: "female" },
  { name: "Captain America", exp: "core_2nd", team: "Avengers", gender: "male" },
  { name: "Cyclops", exp: "core_2nd", team: "X-Men", gender: "male" },
  { name: "Emma Frost", exp: "core_2nd", team: "X-Men", gender: "female" },
  { name: "Gambit", exp: "core_2nd", team: "X-Men", gender: "male" },
  { name: "Hawkeye", exp: "core_2nd", team: "Avengers", gender: "male" },
  { name: "Hulk", exp: "core_2nd", team: "Avengers", gender: "male" },
  { name: "Iron Man", exp: "core_2nd", team: "Avengers", gender: "male" },
  { name: "Nick Fury", exp: "core_2nd", team: "S.H.I.E.L.D.", gender: "male" },
  { name: "Rogue", exp: "core_2nd", team: "X-Men", gender: "female" },
  { name: "Spider-Man", exp: "core_2nd", team: "Spider-Friends", gender: "male" },
  { name: "Spider-Man (Miles Morales)", exp: "core_2nd", team: "Spider-Friends", gender: "male" },
  { name: "Storm", exp: "core_2nd", team: "X-Men", gender: "female" },
  { name: "Thor", exp: "core_2nd", team: "Avengers", gender: "male" },
  { name: "Wolverine", exp: "core_2nd", team: "X-Men", gender: "male" },

  { name: "Doctor Doom 2099", exp: "2099", gender: "male" },
  { name: "Ghost Rider 2099", exp: "2099", team: "Marvel Knights", gender: "male" },
  { name: "Hulk 2099", exp: "2099", team: "Marvel Knights", gender: "male" },
  { name: "Ravage 2099", exp: "2099", team: "Marvel Knights", gender: "male" },
  { name: "Spider-Man 2099", exp: "2099", team: "Spider-Friends", gender: "male" },

  { name: "General Okoye", exp: "black_panther", team: "Heroes of Wakanda", gender: "female" },
  { name: "King Black Panther", exp: "black_panther", team: "Heroes of Wakanda", gender: "male" },
  { name: "Princess Shuri", exp: "black_panther", team: "Heroes of Wakanda", gender: "female" },
  { name: "Queen Storm of Wakanda", exp: "black_panther", team: "Heroes of Wakanda", gender: "female" },
  ...
  { name: "Ant-Man", exp: "ant_man_wasp", team: "Avengers", keywords: ["Size-Changing"], gender: "male" },
  { name: "Cassie Lang", exp: "ant_man_wasp", team: "Avengers", keywords: ["Size-Changing"], gender: "female" },
  { name: "Freedom Fighters", exp: "ant_man_wasp" },
  { name: "Janet Van Dyne", exp: "ant_man_wasp", keywords: ["Size-Changing"], gender: "female" },
  { name: "Jentorra", exp: "ant_man_wasp", gender: "female" },
  { name: "Scott Lang, Cat Burglar", exp: "ant_man_wasp", team: "Crime Syndicate", gender: "male" },
  { name: "Wasp", exp: "ant_man_wasp", team: "Avengers", keywords: ["Size-Changing"], gender: "female" },
  ...
  { name: "Bruce Banner", exp: "infinity_saga", team: "Avengers", gender: "male" },
  { name: "Captain Marvel", exp: "infinity_saga", team: "Avengers", gender: "female" },
  { name: "Doctor Strange", exp: "infinity_saga", team: "Avengers", gender: "male" },
  { name: "Wanda & Vision", exp: "infinity_saga", team: "Avengers" },

  { name: "Blade, Daywalker", exp: "midnight_sons", team: "Marvel Knights", gender: "male" },
  { name: "Elsa Bloodstone", exp: "midnight_sons", team: "Marvel Knights", gender: "female" },
...
const KEYWORDS = [
  { term: "Abomination", definition: "A keyword giving a Villain a Fight Point bonus equal to the printed Fight Points of whichever Hero currently sits in the HQ slot above its city space.", expansions: ["cap_75", "realm_of_kings"] },
  { term: "Adapting Mastermind", definition: "A Mastermind with no separate Mastermind card — instead, its four Mastermind Tactics form a face-up stack, and only the one on top is currently active. Fighting or Master-Striking it shuffles the stack and reveals a new top Tactic ('Adapt'), so you can't predict which one you'll face next.", expansions: ["shield", "2099"] },
  { term: "Ambush", definition: "An effect that triggers the instant a card enters play — a Villain being revealed into the city, or on some Heroes, entering the HQ — rather than waiting to be used normally.", expansions: ["core", "black_panther"] },
  { term: "Ambush Scheme", definition: "A special Scheme card shuffled into the Villain Deck alongside its Villain Group — defeating it scores Victory Points immediately, and for the rest of the game it also triggers whenever a Scheme Twist is played.", expansions: ["ant_man_wasp"] },
  { term: "Antics", definition: "A bonus ability on some cards, usable only if you have at least three cards — between your hand and what you've played this turn — that are low-cost and/or have Size-Changing.", expansions: ["ant_man_wasp"] },
  { term: "Artifact", definition: "A card that stays in front of you turn after turn once played, instead of going to your discard pile at the end of the turn — usable again on later turns without being played again.", expansions: ["dr_strange", "fear_itself", "guardians", "asgard", "guardians_movie"] },
  { term: "Ascending Mastermind", definition: "A powerful Villain that, instead of going to the Escape Pile when it escapes the city, becomes an additional Mastermind — with no Mastermind Tactics of its own, so defeating it once sends it straight to your Victory Pile. All Masterminds in play must be defeated to win.", expansions: ["secret_wars", "secret_wars_2", "x_men"] },
  { term: "Astral Plane", definition: "A unique space beside the Villain Deck where Villains have no physical form — they can only be fought with Recruit Points instead of Attack, and any Villain already there escapes when a new one enters.", expansions: ["dr_strange"] },
  { term: "Berserk", definition: "A keyword that discards the top card of your deck for a bonus equal to that card's printed Fight value — on a Hero it boosts your own Fight Points, but on an enemy it raises the Fight cost you need to match before you can defeat it.", expansions: ["weapon_x", "x_men"] },
  { term: "Betrayal", definition: "An ability printed on Bindings cards, usable only if you don't recruit any Heroes or defeat any Villains that turn — KO one Bindings from your hand this way, and every other player gains all the rest of your Bindings instead.", expansions: ["villains"] },
  { term: "Bindings", definition: "A useless card gained from certain effects (never recruited or drawn from a deck) that produces no Recruit Points or Attack while in your hand — some cards let you turn its burden into an advantage via its own Betrayal ability, or discard it outright.", expansions: ["villains"] },
  { term: "Blood Frenzy", definition: "A keyword giving a bonus for each different Victory Point value among the cards in your Victory Pile, regardless of how many cards share each value.", expansions: ["midnight_sons"] },
  { term: "Bribe", definition: "A keyword letting you fight this Villain by spending any combination of Attack and Recruit Points, instead of only Attack Points.", expansions: ["civil_war", "dark_city", "secret_wars"] },
  { term: "Burning Shards", definition: "A keyword letting you spend a specific number of Shards once per turn for a bonus effect, instead of their normal +1 Fight Point each.", expansions: ["into_the_cosmos"] },
  { term: "Burrow", definition: "A keyword letting a Villain retreat to the Streets when fought there, instead of being defeated — fight it there again, or while another Villain occupies the Streets, to actually finish it off.", expansions: ["fantastic_four"] },
  { term: "Bystander", definition: "A civilian card shuffled into the Villain Deck — defeat it for no reward, Rescue it for Victory Points, or let a Villain capture it to advance the Scheme.", expansions: ["core"] },
  { term: "Celestial Boon", definition: "A permanent bonus effect granted by defeating a Celestial — active for the rest of the game as long as that Celestial stays in your Victory Pile, and stacking with each copy you've defeated.", expansions: ["into_the_cosmos"] },
  { term: "Charge", definition: "A keyword letting a Villain push forward an extra city space right after entering, potentially causing more Villains to escape.", expansions: ["secret_wars_2"] },
  { term: "Cheering Crowds", definition: "A keyword letting you play this card twice in a row by returning a Bystander from your Victory Pile to the Bystander stack.", expansions: ["champions"] },
  { term: "Chivalrous Duel", definition: "A keyword on some Villains that can only be fought using Fight Points from a single Hero Name — you can't combine points from two different Heroes.", expansions: ["ant_man", "messiah_complex"] },
  { term: "Circle of Kung-Fu", definition: "A keyword giving a Villain or Mastermind a large Fight Point bonus unless you reveal a Hero costing at least a specific amount — if it already has one Circle and a Scheme gives it another, only the higher one counts.", expansions: ["secret_wars_2"] },
  { term: "Clone", definition: "A keyword letting you gain another copy of this card from the HQ (or the Hero Deck if none are available in the HQ) the moment you recruit or Ambush it.", expansions: ["messiah_complex"] },
  { term: "Command", definition: "A keyword giving a Villain a Fight Point bonus and/or extra abilities as long as it's the leftmost Villain of its Villain Group in the city.", expansions: ["guardians_movie"] },
  { term: "Conqueror", definition: "A keyword tied to a specific city space, giving a Fight Point bonus whenever any Villain — including the Conqueror card itself — occupies that space.", expansions: ["annihilation", "asgard"] },
  { term: "Contest of Champions", definition: "A keyword where every player reveals a card to compare printed costs — the highest score (ties included) wins, while Evil competes using the best of two cards revealed from the Hero Deck.", expansions: ["into_the_cosmos"] },
  { term: "Coordinate", definition: "A keyword letting you discard the card from your hand (drawing a replacement) so another player can play a free copy of it on their own turn, if they choose to accept it.", expansions: ["spiderman_homecoming"] },
  { term: "Copy a Hero", definition: "An ability that turns this card into an exact duplicate of a Hero you've already played this turn, gaining all of that Hero's stats and text for as long as it stays in play.", expansions: ["core_2nd"] },
  { term: "Cosmic Threat", definition: "A keyword giving a Villain or Mastermind a huge Fight Point penalty for revealing cards of a specific color, usable once per turn during a single fight.", expansions: ["fantastic_four", "into_the_cosmos"] },
  { term: "Critical Hit", definition: "A Superpower Ability requiring two different Hero Class icons instead of one — usable only if you've already played a card of each class earlier in your turn.", expansions: ["dark_city"] },
  { term: "Cross-Dimensional Rampage", definition: "A keyword forcing each player to reveal a Hero or Victory Pile card matching a specific theme (like 'Party' or 'Demon') from their own cards, or else gain a Wound.", expansions: ["what_if", "secret_wars", "secret_wars_2", "world_war_hulk"] },
  { term: "Cyber-Mod", definition: "A keyword usable only if you have a card of the listed Hero Class in your Victory Pile — Villains and Masterminds have their own version, usable only while a card of the listed class sits in the Escape Pile instead.", expansions: ["2099"] },
  { term: "Danger Sense", definition: "A keyword that reveals cards from the top of the Villain Deck, gives you a Fight Point bonus for each Villain revealed, then returns all the cards to the top in any order you choose.", expansions: ["into_the_cosmos", "spiderman_homecoming"] },
  { term: "Dark Memories", definition: "A keyword giving a Fight Point bonus based on how many distinct Hero Classes appear among the cards in your discard pile.", expansions: ["black_widow", "revelations"] },
  { term: "Defeat", definition: "An instruction to treat an enemy as defeated without paying its Fight cost or meeting any special fighting requirements — you still get its Fight effect and Victory Points as normal.", expansions: ["dark_city"] },
  { term: "Demolish", definition: "A keyword that reveals the top card of the Hero Deck, then forces each player to discard a card from their hand matching its cost.", expansions: ["champions", "fear_itself", "villains"] },
  { term: "Demonic Bargain", definition: "A keyword letting a chosen player discard the top card of their deck — if it costs 1 or more, they gain a Wound, but either way they get the listed bonus effect.", expansions: ["dr_strange"] },
  { term: "Digest", definition: "A keyword usable only if you have at least a specific number of cards in your Victory Pile — any kind of card there counts, and using it doesn't remove any.", expansions: ["venom"] },
  { term: "Divided Cards", definition: "A single Hero card printed as two mini-cards sharing one card — each time you play it, choose which side's stats and abilities to use, ignoring the other entirely.", expansions: ["black_widow", "infinity_saga", "guardians_movie", "x_men"] },
  { term: "Dodge", definition: "A keyword letting you discard this card from your hand on your turn to draw a replacement, instead of playing it for its printed abilities.", expansions: ["black_widow", "villains"] },
  { term: "Dominate", definition: "A keyword that puts a Hero under a Villain or Mastermind, giving it a Fight Point bonus for each Hero it's Dominating — when you defeat it, each player gets one of the Dominated Heroes into their discard pile, and any left over are KO'd. If the enemy escapes instead, its Dominated Heroes go to the Escape Pile too.", expansions: ["x_men"] },
  { term: "Double-Cross", definition: "A keyword forcing every player to reveal their hand and discard one of their highest-cost duplicate cards.", expansions: ["ant_man_wasp"] },
  { term: "Elusive", definition: "A keyword requiring you to have generated at least a specific amount of Attack this turn before you're allowed to fight this Villain — you don't have to actually spend that Attack, just have made it available this turn.", expansions: ["villains"] },
  { term: "Empowered", definition: "A keyword giving a Hero, Villain, or Mastermind a Fight Point bonus for each card of a matching color currently in the HQ.", expansions: ["ant_man", "what_if"] },
  { term: "Endgame", definition: "A keyword giving an enemy a bonus (or other ability) that only applies once the Villain Deck has shrunk to 8 cards per player or fewer, representing the fight's climactic final stretch.", expansions: ["infinity_saga"] },
  { term: "Enraging Wounds", definition: "A tougher Wound variant with its own unique Healing ability and, unlike normal Wounds, a bonus effect if you play it — its Healing ability can be used anytime, even after fighting or recruiting that turn.", expansions: ["weapon_x"] },
  { term: "Escape", definition: "An effect that triggers when a Villain is pushed off the final city space without being defeated, instead of being fought.", expansions: ["core"] },
  { term: "Evil Wins", definition: "The part of every Scheme card explaining exactly how the Mastermind completes their plan and wins the game for evil, if the players don't stop it in time.", expansions: ["core_2nd"] },
  { term: "Excessive Kindness", definition: "A keyword usable once per turn — spend 1 more Recruit Point than needed to recruit a Hero, and you get to use every Excessive Kindness ability on the Heroes you've played this turn.", expansions: ["guardians_movie"] },
  { term: "Excessive Violence", definition: "A keyword usable once per turn — spend one more Attack than needed to defeat a Villain or Mastermind, and you get to use every Excessive Violence ability on the Heroes you've played this turn.", expansions: ["deadpool", "guardians_movie", "venom"] },
  { term: "Explore", definition: "A keyword that swaps a Hero out of the HQ for a fresh one from the top of the Hero Deck, sometimes granting a bonus based on the Hero it finds.", expansions: ["ant_man_wasp"] },
  { term: "Fail", definition: "What happens when you try to fight a Berserk enemy but don't have enough Fight Points after its bonus applies — you gain a Wound, lose all your Fight Points, and can't fight again this turn, though you can still play cards and recruit.", expansions: ["weapon_x"] },
  { term: "Fated Future", definition: "A keyword letting you put this card on the bottom of your deck instead of your discard pile when you play it, so you draw it again once your deck cycles instead of waiting for a reshuffle.", expansions: ["2099"] },
  { term: "Fateful Resurrection", definition: "A keyword that reveals the top card of the Villain Deck when this Villain is fought — if it's a Scheme Twist or Master Strike, this Villain reenters the city instead of going to your Victory Pile.", expansions: ["secret_wars_2"] },
  { term: "Feast", definition: "A keyword that treats fighting this Villain or Mastermind as also triggering its listed Fight effect — most commonly used to KO the top card of a player's deck.", expansions: ["paint_town_red", "world_war_hulk"] },
  { term: "Fight", definition: "Spending Attack Points to defeat a Villain in the city, a Bystander, or a Master Strike.", expansions: ["core"] },
  { term: "Fight or Fail", definition: "A secondary effect on enemies with Uru-Enchanted Weapons — it triggers whenever you fight that enemy, whether or not you actually had enough Fight Points to defeat it.", expansions: ["2099"] },
  { term: "Focus", definition: "A keyword letting you spend Recruit Points for a repeatable bonus effect for the rest of the turn, as many times as you can afford.", expansions: ["annihilation", "fantastic_four"] },
  { term: "Fortify", definition: "A keyword that makes a Villain immune to being fought while it sits at a specified location — fighting that Villain there ends the effect and puts it in your Victory Pile as normal.", expansions: ["civil_war"] },
  { term: "Grievous Wounds", definition: "A tougher variant of Wound that needs a specific Healing cost to remove instead of the normal method, but still counts as a Wound for every other card effect.", expansions: ["civil_war"] },
  { term: "Haunt", definition: "A keyword that tucks this Villain beneath an unhaunted Hero in the HQ instead of entering the city, blocking that Hero from being recruited until a player pays Fight Points equal to its cost to exorcise it and send the Villain into the city.", expansions: ["midnight_sons"] },
  { term: "Heist", definition: "A once-per-turn action comparing the variety of Hero costs you've played this turn against the top card of the Villain Deck — beat it to trigger every Heist ability from cards you played or fought that turn.", expansions: ["ant_man_wasp"] },
  { term: "Hero Class", definition: "A colored category (like Covert, Instinct, Strength, or Tech) printed on most Hero cards — plain S.H.I.E.L.D. Agents and Troopers have none. Many abilities check how many Hero Classes you've played, or a specific one.", expansions: ["cap_75"] },
  { term: "Heroic Bystanders", definition: "A Special Bystander that becomes a Hero card and joins your discard pile when you rescue it, instead of just adding Victory Points.", expansions: ["x_men"] },
  { term: "Hidden Witness", definition: "A face-down Bystander captured by a Villain, Mastermind, Scheme, or even a Hero in the HQ — pay 2 Recruit Points to rescue each one, which you must do before fighting that Villain or recruiting that Hero.", expansions: ["noir"] },
  { term: "Highest Abomination", definition: "A variant of Abomination that gives a Fight Point bonus equal to the highest printed Fight value among all five Heroes in the HQ, instead of just the one Hero in a specific city space.", expansions: ["realm_of_kings"] },
  { term: "Horrors", definition: "An optional, extra-tough card type that some Epic Masterminds add to the game for a harder challenge — players can also choose to add any number of Horrors at the start of a game against any Mastermind, just to raise the difficulty.", expansions: ["x_men"] },
  { term: "HQ", definition: "The row of face-up Hero cards available to Recruit from.", expansions: ["core"] },
  { term: "Human Shields", definition: "A keyword that captures Bystanders face-down instead of face-up — you can't fight that Villain at all until you've individually paid to rescue each Human Shield, at a cost equal to the Villain's current Fight value.", expansions: ["x_men"] },
  { term: "Hunt for Victims", definition: "A keyword that KOs a Bystander already captured by any Villain or Mastermind (or sitting in the Escape Pile) — if there's no such Bystander, it captures a new one instead.", expansions: ["midnight_sons"] },
  { term: "Hydra Level", definition: "A keyword giving a bonus based on how many S.H.I.E.L.D. and/or HYDRA cards are currently in the Escape Pile — the HYDRA counterpart to S.H.I.E.L.D. Level.", expansions: ["shield"] },
  { term: "Hyperspeed", definition: "A keyword that reveals a set number of cards from the top of your deck, gives you a bonus (Attack, Recruit, or both) for each revealed card with a matching icon, then discards all the revealed cards.", expansions: ["revelations"] },
  { term: "Indigestion", definition: "A fallback ability on cards that also have Digest — use this weaker effect instead if you don't have enough cards in your Victory Pile to meet the Digest requirement.", expansions: ["venom"] },
  { term: "Investigate", definition: "A keyword letting you look at the top two cards of your deck (or another specified deck), reveal and draw one matching a stated trait, then return the rest to the top and/or bottom in any order.", expansions: ["dimensions", "noir", "messiah_complex"] },
  { term: "KO'd", definition: "A card removed from the game entirely — out of every deck, hand, and discard pile for the rest of the game.", expansions: ["core"] },
  { term: "Last Stand", definition: "A keyword giving a Fight Point bonus for each empty city space — a space still counts as empty even if it has a Location above it, as long as no Villain is there.", expansions: ["revelations"] },
  { term: "Liberate", definition: "A keyword giving a Fight Point bonus usable only against a Villain holding Bystanders, or against the Mastermind (whether or not it's holding Bystanders).", expansions: ["what_if"] },
  { term: "Lightshow", definition: "A keyword usable once per turn if you've played at least two cards with it — pick a single Lightshow ability from any of those cards to use, no matter how many more you've played.", expansions: ["x_men"] },
  { term: "Location", definition: "A card type representing an infamous stronghold — placed above a city space when drawn from the Villain Deck, staying put as Villains move through it. Fight it like a Villain for its listed cost to add it to your Victory Pile, though Locations don't count as Villains for other effects.", expansions: ["revelations"] },
  { term: "Man and Woman Out of Time", definition: "A keyword letting a Hero be set aside after you use its ability, then played again for free at the start of your next turn before being discarded.", expansions: ["annihilation"] },
  { term: "Mass Momentum", definition: "A Mastermind variant of Momentum that scales its bonus with how many Villains in the city entered a new space this turn, not just itself.", expansions: ["annihilation"] },
  { term: "Master Strike", definition: "A powerful card unique to the Mastermind, shuffled into the Villain Deck partway through the game and tougher than a normal Villain.", expansions: ["core"] },
  { term: "Mastermind Tactic", definition: "One of four face-down cards under a Mastermind — drawn at random and revealed each time you fight it, its Fight effect applies before it goes to the KO pile.", expansions: ["core"] },
  { term: "Microscopic Size-Changing", definition: "A more powerful version of Size-Changing that can reduce a card's Recruit or Fight cost below zero, actually gaining you the difference instead.", expansions: ["ant_man"] },
  { term: "Momentum", definition: "A keyword giving a Villain a Fight Point bonus for entering a new city space this turn, whether it walked in, was pushed, or was moved there.", expansions: ["annihilation"] },
  { term: "Moonlight", definition: "A keyword active only when most Heroes in the HQ have odd-numbered printed costs — if there's a tie, neither Moonlight nor Sunlight is active.", expansions: ["midnight_sons", "new_mutants"] },
  { term: "Multiclass", definition: "A keyword marking a card as counting toward more than one Hero Class or Villain Class at once — it satisfies any ability that checks for either class's icon.", expansions: ["black_panther", "infinity_saga", "what_if", "secret_wars", "secret_wars_2"] },
  { term: "New Recruit", definition: "A card providing a temporary burst of Recruit Points or Attack — the moment you play it, it returns to a shared face-down stack instead of going to your discard pile, so you never draw the same one twice in a row.", expansions: ["villains"] },
  { term: "Outwit", definition: "A keyword usable only if you reveal Heroes with a specific number of different printed costs among your hand and the cards you've already played this turn — the card itself counts toward that total.", expansions: ["world_war_hulk"] },
  { term: "Own", definition: "All the cards that belong to you — your hand, deck, played cards, discard pile, and Victory Pile — as opposed to a shared pile or another player's cards.", expansions: ["dark_city"] },
  { term: "Patrol", definition: "A keyword usable only while a specified city space is completely empty of cards — once anything occupies that space during the turn, the ability is off again.", expansions: ["midnight_sons", "secret_wars_2"] },
  { term: "Phasing", definition: "A keyword letting you swap a card in your hand for the top card of your deck during your turn, without it counting as playing or drawing a card.", expansions: ["civil_war", "infinity_saga"] },
  { term: "Piercing Energy", definition: "A special resource some Heroes generate, letting you fight a Villain or Mastermind by spending Piercing Energy equal to its printed Victory Points instead of its Fight value — ignoring its Fight value, any Fight modifiers, and most special fighting requirements.", expansions: ["x_men"] },
  { term: "Prey", definition: "A keyword that has this Villain single out whichever player has the fewest cards of a specific type in hand when it enters the city — if nobody defeats it by the end of that player's turn, its 'Finish the Prey' effect triggers against them.", expansions: ["messiah_complex"] },
  { term: "Printed Value", definition: "The number literally shown inside a card's Attack, Recruit, or Cost icon, ignoring any current bonuses, penalties, or modifiers — some abilities specifically check this raw value instead of a card's current one.", expansions: ["core_2nd", "weapon_x"] },
  { term: "Recruit", definition: "Spending Recruit Points to buy a Hero card from the HQ into your discard pile.", expansions: ["core"] },
  { term: "Rescue", definition: "Some Heroes let you save a Bystander instead of fighting it, turning it face-down into a Victory Point card.", expansions: ["core"] },
  { term: "Reveal", definition: "Show the other players a card from your hand or one you've already played this turn — revealing a card doesn't play, discard, or otherwise move it.", expansions: ["core_2nd"] },
  { term: "Revenge", definition: "A keyword giving a Villain a Fight Point bonus for each Villain from a specific group already in your Victory Pile.", expansions: ["deadpool"] },
  { term: "Rise of the Living Dead", definition: "A keyword on some Villains — each player checks the top card of their Victory Pile, and if it's a Villain with this same keyword, it reenters the city, doing its Ambush ability again.", expansions: ["what_if", "secret_wars"] },
  { term: "Ritual Artifact", definition: "An Artifact that can be discarded for a bonus effect once you've fulfilled its listed condition that turn, instead of leaving it in play.", expansions: ["dr_strange"] },
  { term: "S.H.I.E.L.D. Clearance", definition: "A keyword forcing you to discard one or more S.H.I.E.L.D. Heroes as an extra cost to fight that Villain or Mastermind.", expansions: ["civil_war"] },
  { term: "S.H.I.E.L.D. Level", definition: "A keyword giving a bonus usable only if you have enough S.H.I.E.L.D. and/or HYDRA cards in your Victory Pile to meet the listed number — checking, not spending, so it doesn't remove them.", expansions: ["shield"] },
  { term: "S.H.I.E.L.D. Officer", definition: "A basic Hero recruited by spending a fixed Recruit cost from the shared Officer Deck, instead of using HQ Recruit Points — you can recruit as many as you can afford in a turn.", expansions: ["core_2nd"] },
  { term: "Sacrifice", definition: "A keyword letting you KO this card to use a bonus ability, usable only if you've already played another card of the matching Hero Class earlier in the turn — you still get the card's normal Recruit, Fight, and other abilities whether or not you Sacrifice it.", expansions: ["infinity_saga"] },
  { term: "Savior", definition: "A bonus ability on some Heroes and Villains, usable only if you have at least 3 Bystanders in your Victory Pile.", expansions: ["cap_75"] },
  { term: "Shard", definition: "A token that players, Villains, and Masterminds can gain from a shared supply — players spend one for +1 Fight Point, while a Villain or Mastermind gets a permanent Fight Point bonus for each one it holds.", expansions: ["guardians", "into_the_cosmos"] },
  { term: "Shatter", definition: "A keyword that halves an enemy's — or a Hero's in the HQ — current Fight value or cost, rounded up, for the rest of the turn. It can stack if used multiple times.", expansions: ["messiah_complex"] },
  { term: "Sidekick", definition: "A special card kept face-down in a shared Sidekick Stack — pay a Recruit cost once per turn to add the top one to your discard pile, or gain one for free when a card effect says to.", expansions: ["civil_war", "messiah_complex", "secret_wars"] },
  { term: "Size-Changing", definition: "A keyword on some Heroes and Villains that discounts their Recruit or Fight cost if you played a card of a specific type this turn.", expansions: ["ant_man"] },
  { term: "Smash", definition: "A keyword letting you discard another card from your hand for a Fight Point bonus.", expansions: ["world_war_hulk"] },
  { term: "Soaring Flight", definition: "A keyword that sets a Hero aside the moment you recruit it, adding it to your hand as a bonus extra card at the end of that turn.", expansions: ["x_men"] },
  { term: "Soulbind", definition: "A keyword letting you take a Villain card from your Victory Pile and turn it face down at the bottom of the pile for a bonus effect — it stops counting as being in your Victory Pile until you tally Victory Points at the end of the game.", expansions: ["what_if"] },
  { term: "Special Bystander", definition: "A Bystander with a bonus effect that triggers when you Rescue it, on top of the usual Victory Point.", expansions: ["core_2nd"] },
  { term: "Spectrum", definition: "A keyword usable only if you have at least 3 different Hero Classes among your hand and the cards you've played this turn.", expansions: ["secret_wars_2"] },
  { term: "Striker", definition: "A keyword giving a Fight Point bonus for each Master Strike currently in the KO pile and/or stacked next to the Mastermind — some Masterminds count Master Strikes in other unusual places instead, like the city or players' Victory Piles.", expansions: ["spiderman_homecoming"] },
  { term: "Sunlight", definition: "A keyword active only when most Heroes in the HQ have even-numbered printed costs — the counterpart to Moonlight.", expansions: ["midnight_sons", "new_mutants"] },
  { term: "Superpower Ability", definition: "A bonus effect on a Hero card, marked with a Hero Class icon and a colon, usable only if you've already played another card of that same class earlier in the turn.", expansions: ["core"] },
  { term: "Switcheroo", definition: "A keyword used instead of playing a card — reveal it from your hand and put it on the bottom of the Hero Deck, then take a Hero of the matching printed cost from the HQ into your hand.", expansions: ["dimensions"] },
  { term: "Symbiote Bonds", definition: "A keyword letting you stack a Villain onto another Villain in the same city space, combining them into a single Combined Villain with both cards' Fight values and abilities added together — fight it by paying the total, then choose one of the two cards for your Victory Pile and its Fight effect.", expansions: ["venom"] },
  { term: "Tactical Formation", definition: "A Superpower-like ability usable only if you have a specific combination of Hero costs among 'Heroes you have,' counting the card itself.", expansions: ["messiah_complex"] },
  { term: "Teleport", definition: "A keyword letting you set this card aside instead of playing it — it joins your hand as a bonus extra card at the end of your turn.", expansions: ["dark_city", "dimensions", "realm_of_kings", "secret_wars", "secret_wars_2"] },
  { term: "Throne's Favor", definition: "A shared token representing control of a contested seat of power — only one exists at a time, and gaining it takes it away from whoever currently holds it, including the Mastermind.", expansions: ["black_panther", "realm_of_kings"] },
  { term: "Thrown Artifact", definition: "An Artifact that can be 'thrown' — put it on the bottom of your deck to use its ability immediately, instead of keeping it in play, so it can shuffle back into your hand again quickly.", expansions: ["fear_itself", "asgard"] },
  { term: "Token Cards", definition: "A card representing a special character that enters the game some other way (like a Master Strike ability) instead of being recruited or drawn normally — purely optional to include.", expansions: ["x_men"] },
  { term: "Transform", definition: "An instruction to swap a card for a different one — on a Mastermind, flip the double-sided card over to its other side; on a Hero, permanently replace it with a new card, removing the original from the game.", expansions: ["ant_man_wasp", "world_war_hulk"] },
  { term: "Transforming Scheme", definition: "A double-sided Scheme that starts on its 'Setup' side and flips to its other side the moment a Twist tells it to — only the rules on the currently face-up side apply from that point on.", expansions: ["revelations"] },
  { term: "Traps", definition: "A card type in the Villain Deck that gives you a challenge to complete that turn — succeed and it goes to your Victory Pile for its Victory Points, fail and you suffer its listed consequence at the end of the turn. Traps don't push Villains forward when played.", expansions: ["world_war_hulk", "x_men"] },
  { term: "Triggered Artifact", definition: "An Artifact with a repeatable ability that fires every time a specific trigger happens during your turn, for as long as you control it.", expansions: ["guardians_movie"] },
  { term: "Twist", definition: "A card in the Villain Deck that triggers a Scheme-specific effect when revealed, instead of being fought.", expansions: ["core"] },
  { term: "Ultimate Abomination", definition: "A Mastermind variant of Abomination that adds up the printed Fight Points of every Hero currently in the HQ, instead of just one.", expansions: ["cap_75"] },
  { term: "Undercover", definition: "A keyword that sends a Hero to your Victory Pile early as a 1-point card instead of your discard pile, to be Unleashed back to your hand later.", expansions: ["black_widow", "shield"] },
  { term: "Unleash", definition: "Returning a Hero from your Victory Pile to your hand, usually triggered by fighting a Villain — you can play it again that same turn.", expansions: ["black_widow"] },
  { term: "Unveiled Scheme", definition: "The transformed side of a Veiled Scheme — once triggered, the original Scheme is removed from the game and replaced with a randomly selected Unveiled Scheme from among the ones in play, continuing the game with new rules.", expansions: ["messiah_complex"] },
  { term: "Uru-Enchanted Weapons", definition: "A keyword making an enemy tougher to fight — reveal that many cards from the top of the Villain Deck and add up their Victory Points as a bonus to the enemy's Fight value before you can defeat it.", expansions: ["fear_itself", "2099"] },
  { term: "Versatile", definition: "A keyword letting you choose Recruit Points or Fight Points — not both — for the printed amount when you play the card.", expansions: ["champions", "dark_city"] },
  { term: "Victory Pile", definition: "Your personal collection of defeated Villains and rescued Bystanders, kept face-up and separate from your discard pile — each card in it is worth Victory Points at the end of the game.", expansions: ["core"] },
  { term: "Villainous Weapon", definition: "A non-Villain card in the Villain Deck that gets captured by the Villain closest to the deck when it's played, empowering that Villain with a Fight Point bonus — defeat the Villain to claim the Weapon as your own Artifact.", expansions: ["asgard", "guardians_movie"] },
  { term: "Villains You Gain as Heroes", definition: "A rare card type that starts in the Villain Deck as a Villain, but the moment you defeat it in a fight, it becomes a Hero and joins your discard pile instead of your Victory Pile — its old Villain Attack value doubles as its Hero cost if anything needs to know it.", expansions: ["secret_wars", "secret_wars_2"] },
  { term: "Waking Nightmare", definition: "A keyword that discards a non-grey Hero from your hand — if you discard a Hero this way, draw a card.", expansions: ["new_mutants"] },
  { term: "Wall-Crawl", definition: "A keyword letting you put this Hero on top of your deck instead of your discard pile when you recruit it — you'll draw it again almost immediately instead of waiting for your deck to reshuffle.", expansions: ["paint_town_red", "secret_wars_2", "spiderman_homecoming"] },
  { term: "Weapon X Sequence", definition: "A keyword giving a bonus equal to the longest unbroken run of different consecutive printed costs among your cards — on a Hero it's your own hand and cards played this turn, on an enemy it's the Heroes currently in the HQ.", expansions: ["weapon_x"] },
  { term: "What If...?", definition: "A keyword letting you choose a Hero Class or Hero Name, then reveal the top card of your deck and choose to keep it on top or discard it — if the revealed card matches what you chose, you get the listed bonus effect.", expansions: ["what_if"] },
  { term: "When Recruited", definition: "A trigger on some Heroes that happens the moment you recruit them, before they've even reached your discard pile.", expansions: ["black_widow", "realm_of_kings"] },
  { term: "Worthy", definition: "A keyword condition met by having a Hero that costs 5 or more among 'your Heroes' — some cards reward or require it.", expansions: ["asgard"] },
  { term: "Wound", definition: "A useless card added to your deck, usually from a Villain's attack — it clutters your hand until you find a way to remove it.", expansions: ["core"] },
  { term: "Wound a Villain", definition: "An ability on some Heroes letting you place a Wound card onto a Villain instead of playing it — the Villain gets weaker for each Wound on it until it's defeated or leaves the city.", expansions: ["black_panther"] },
  { term: "Wounded Fury", definition: "A keyword giving a Fight Point bonus for each Wound in your discard pile — appears on both Heroes (boosting themselves) and Villains/Masterminds (making them tougher).", expansions: ["world_war_hulk"] },
  { term: "X-Gene", definition: "A keyword giving a bonus if you have at least one card of a specific Hero Class in your discard pile — it doesn't matter how many matching cards you have, and it only triggers once per card even if you meet several different X-Gene conditions on it.", expansions: ["x_men"] },
  { term: "X-Treme Attack", definition: "A keyword giving a Villain a Fight Point bonus for each other Villain in the city that also has X-Treme Attack.", expansions: ["villains"] },
];
